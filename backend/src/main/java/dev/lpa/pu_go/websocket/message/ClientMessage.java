...
public sealed interface ClientMessage permits ClientMessage.Ping, ClientMessage.CreateRoom, ClientMessage.JoinRoom, ClientMessage.LeaveRoom, ClientMessage.MovePlayer {
    int version();
    String type();
