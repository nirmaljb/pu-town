...
<tileset version="1.10" tiledversion="1.11.0" name="oak_autumn" tilewidth="192" tileheight="192" tilecount="8" columns="8" objectalignment="bottomleft">
 <image source="oak_autumn.png" width="1536" height="192"/>
 <tile id="0">
  <animation>
