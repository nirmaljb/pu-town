...
<tileset version="1.10" tiledversion="1.11.0" name="pine_tall" tilewidth="192" tileheight="256" tilecount="8" columns="8" objectalignment="bottomleft">
 <image source="pine_tall.png" width="1536" height="256"/>
 <tile id="0">
  <animation>
